# Generated by Django 3.2.18 on 2023-03-12 10:08
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=255, unique=True, verbose_name='Название')),
                ('color_tag', models.CharField(max_length=32, unique=True, verbose_name='Код цвета')),
                ('slug', models.SlugField(max_length=255, unique=True, verbose_name='Слаг для тега')),
            ],
            options={
                'verbose_name': 'Тег',
